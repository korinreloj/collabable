    ...
    <div class="main_page">
        ...
        <form method="POST">
            ...
            <div class="form_content approval_content upload_content">
                <h4 class="deactivate_user-msg">You are about to deactivate this user: <b>[Name]</b>. Are you sure you want to proceed?</h4>
                <div class="form_buttons">
                    <button class="cancel_project">Cancel</button>

                    <button class="create_project" type="submit" id="submit" name="submit">Deactivate</button>
                </div>
            </div>
        </form>
    </div>
